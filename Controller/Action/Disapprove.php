...
class Disapprove extends Action
{
    ...
    public function execute()
    {
        ...
        if ($reviewId) {
            ...
            if ($review->getId()) {
                $review->setStatusId(Review::STATUS_NOT_APPROVED)->save();
                $this->messageManager->addSuccessMessage(__('Review disapproved successfully.'));

                // Get product ID and generate product URL with #reviews
